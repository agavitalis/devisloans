                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class=money-transfer-form>
                            <form>
                                ...
                                <div class=form-group> <label>Recipient gets</label>
                                    <div class=money-transfer-field> <input class=form-control autocomplete=off
                                            value="3,000">
                                        <div class=amount-currency-select> <select>
                                                <option>NGN</option>
                                ...
                                <div class=money-transfer-info> <span>You can borrow with or without
                                        <strong>Referrals</strong></span> </div><button type=submit
            ...
            <div class="row m-0">
                <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                    <div class=single-featured-box>
                        ...
                        <p>Lorem ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan.</p><a
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                    <div class=single-featured-box>
                        ...
                        <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan.</p><a
                            href="/faq" class=read-more-btn>Read More</a>
                    </div>
                </div>
            </div>
        ...
        <div class=row>
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class=single-how-it-works> <img src="frontend/img/how-it-works-image/1.png" alt=image>
                    ...
                    <p>Ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel
                        adipiscing aliqua.</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-6">
        ...
        <div class=overview-box>
            <div class=overview-content>
                <div class="content left-content"> <span class=sub-title>Fast & Easy Online Loans</span>
                    ...
                    </ul> <a href="#" class="btn btn-primary">Apply Now</a>
                </div>
            </div>
...
<section class="services-area ptb-70 bg-f7fafd">
    <div class="container-fluid p-0">
        <div class=overview-box>
            ...
            <div class=overview-content>
                <div class=content> <span class=sub-title>Top Security</span>
        ...
        <div class=overview-box>
            <div class=overview-content>
                <div class="content left-content"> <span class=sub-title>Price Transparency</span>
                    ...
                    </ul> <a href="#" class="btn btn-primary">Create Account</a>
                </div>
            </div>
            <div class=overview-image>
...
<section class="services-area ptb-70 bg-f7fafd">
    <div class="container-fluid p-0">
        <div class=overview-box>
            <div class=overview-image>
                <div class=image> <img src="frontend/img/7.jpg" alt=image> </div>
            </div>
            <div class=overview-content>
                <div class=content> <span class=sub-title>Automated Accounting</span>
                    ...
                    <div class=row>
                        <div class="col-lg-12 col-sm-6 col-md-6">
                            <div class=features-box>
                                ...
                                <p>Lorem ipsum dolor amet, adipiscing, sed do eiusmod tempor incididunt ut labore
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class=invoicing-content>
                    <h2>Easy way to get interest free loans and get a better filling at home</h2>
                    <div class=bar></div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip.</p><a href="#" class="btn btn-primary">Get Started</a>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
...
<section class="funfacts-area ptb-70 pt-0">
    <div class=container>
        ...
        <div class=contact-cta-box>
            ...
            <p>Don't hesitate to contact us</p><a href="#" class="btn btn-primary">Contact Us</a>
        </div>
                ...
                <div>
                    <div class=item>
                        <div class=single-feedback>
                            ...
                            <h3>John Lucy</h3><span>Web Developer</span>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            ...
                            <h3>John Smith</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            ...
                            <h3>Maxwel Warner</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            ...
                            <h3>Ross Taylor</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            <div class=client-img><img src="frontend/img/client-image/5.jpg" alt=image></div>
                            <h3>James Anderson</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            <div class=client-img><img src="frontend/img/client-image/1.jpg" alt=image></div>
                            <h3>Steven Smith</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            <div class=client-img><img src="frontend/img/client-image/2.jpg" alt=image></div>
                            <h3>Steven Lucy</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    ...
                    <div class=item>
                        <div class=single-feedback>
                            <div class=client-img><img src="frontend/img/client-image/3.jpg" alt=image></div>
                            <h3>John Terry</h3><span>Web Developer</span>
                            <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                                lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
...
<section class=ready-to-talk>
    <div class=container>
        <div class=ready-to-talk-content>
            <h3>Ready to talk?</h3>
            <p>Our team is here to answer your question about Luvion</p><a href="#" class="btn btn-primary">Contact
                Us</a> <span><a href="#">Or, get started now with a free trial</a></span>
        </div>
    </div>
</section>
        ...
        <div class=partner-inner>
            <div class="row align-items-center">
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
                            src="frontend/img/partner-image/partner-1.png" alt=partner><img
                            src="frontend/img/partner-image/partner-hover1.png" alt=partner></a></div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
                            src="frontend/img/partner-image/partner-2.png" alt=partner><img
                            src="frontend/img/partner-image/partner-hover2.png" alt=partner></a></div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
                            src="frontend/img/partner-image/partner-3.png" alt=partner><img
                            src="frontend/img/partner-image/partner-hover3.png" alt=partner></a></div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
                            src="frontend/img/partner-image/partner-4.png" alt=partner><img
                            src="frontend/img/partner-image/partner-hover4.png" alt=partner></a></div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
                            src="frontend/img/partner-image/partner-5.png" alt=partner><img
                            src="frontend/img/partner-image/partner-hover5.png" alt=partner></a></div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
                            src="frontend/img/partner-image/partner-6.png" alt=partner><img
                            src="frontend/img/partner-image/partner-hover6.png" alt=partner></a></div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-6"><a href="#"><img
...
<section class=account-create-area>
    <div class=container>
        <div class=account-create-content>
            ...
            <p>Get your Luvion account today!</p><a href="#" class="btn btn-primary">Get Your Luvion Account</a>
        </div>
    </div>
</section>
